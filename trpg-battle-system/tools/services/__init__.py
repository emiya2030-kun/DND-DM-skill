...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "UseSecondWind": ("tools.services.class_features.fighter.use_second_wind", "UseSecondWind"),
    "UseActionSurge": ("tools.services.class_features.fighter.use_action_surge", "UseActionSurge"),
    "UseLayOnHands": ("tools.services.class_features.paladin.use_lay_on_hands", "UseLayOnHands"),
    "UseDivineSpark": ("tools.services.class_features.cleric.use_divine_spark", "UseDivineSpark"),
    "UseBardicInspiration": (
    ...
    "UseArmorOfShadows": ("tools.services.class_features.warlock.use_armor_of_shadows", "UseArmorOfShadows"),
    "UseFiendishVigor": ("tools.services.class_features.warlock.use_fiendish_vigor", "UseFiendishVigor"),
    "UseContactPatron": ("tools.services.class_features.warlock.use_contact_patron", "UseContactPatron"),
    "UseGazeOfTwoMinds": ("tools.services.class_features.warlock.use_gaze_of_two_minds", "UseGazeOfTwoMinds"),
    ...
    "UsePactOfTheChain": ("tools.services.class_features.warlock.use_pact_of_the_chain", "UsePactOfTheChain"),
    "UseNaturesVeil": ("tools.services.class_features.ranger.use_natures_veil", "UseNaturesVeil"),
    "UseWildShape": ("tools.services.class_features.druid.use_wild_shape", "UseWildShape"),
    "UseSuperiorDefense": ("tools.services.class_features.monk.use_superior_defense", "UseSuperiorDefense"),
