...
from tools.services.combat.grapple.shared import extract_grapple_source_id
...
class EscapeGrapple:
    ...
    def execute(self, *, encounter_id: str, actor_id: str) -> dict[str, object]:
        ...
        escape_dc = int(active_grapple.get("escape_dc", 0) or 0)
        ...
        if max(athletics, acrobatics) >= escape_dc:
            ...
            if isinstance(grappler.combat_flags, dict):
