...
class EncounterCastSpell:
    ...
    def execute(
        ...
        *,
        ...
        caster = self._get_caster_or_raise(encounter, actor_id=actor_id)
    ...
    def _get_caster_or_raise(
        ...
        *,
        ...
        if actor_id is None:
            return self._get_current_entity_or_raise(encounter)
        entity = encounter.entities.get(actor_id)
        if entity is None:
    ...
    def _resolve_target_ids(self, encounter: Encounter, target_ids: list[str]) -> list[str]:
        ...
        for target_id in target_ids:
            if target_id not in encounter.entities:
